		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FIORI Template based Master-Detail Application",
									"targetURL": "#r9masterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r9masterdetail-display": {
								"semanticObject": "r9masterdetail",
								"action": "display",
								"description": "FIORI Template based Master-Detail Application",
								"title": "FIORI Template based Master-Detail Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r9masterdetail",
									"url": sap.ui.require.toUrl("r9masterdetail")
								}
							}
						}
					}
