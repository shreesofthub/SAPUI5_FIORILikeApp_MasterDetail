sap.ui.define([
    ...
    return BaseController.extend("r9masterdetail.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                Prdprice: function(oContext) {
                    var iNumber = oContext.getProperty('Prdprice'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Prdid", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "r9masterdetail.view.ViewSettingsDialog",
                    controller: this
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1" :
                        aFilters.push(new Filter("Prdprice", FilterOperator.LE, 100));
                        break;
                    case "Filter2" :
                        aFilters.push(new Filter("Prdprice", FilterOperator.GT, 100));
                        break;
                    default :
                        break;
                }
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("Prdid")
            }, bReplace);
        },
